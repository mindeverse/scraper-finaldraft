"""Final Draft Shopify parser — /collections/{handle}/products.json with EUR cookie."""
...
def fetch_collection_products(category_url: str) -> list[dict[str, Any]]:
    ...
    while True:
        ...
        for raw in batch:
            parsed = parse_shopify_product(raw, category=display, collection_handle=handle)
            if parsed:
