"""Final Draft scraper — scrape Shopify collections, embed with local SigLIP, upsert Supabase."""
...
logger = logging.Logger("scraper-finaldraft")
...
def run() -> dict[str, Any]:
    logger.info("=== Final Draft scraper start ===")
    ...
    for k, v in summary.items():
        logger.info("%s: %s", k, v)
    logger.info("=== Final Draft scraper complete ===")
    return summary
